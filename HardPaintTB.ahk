...
Random, clickDelay, SlowestClick, Fastestclick
...
Gui, Add, Text, x20 y330 vFastestClickText, Fastest Click (ms):
Gui, Add, Edit, x150 y330 w120 vFastestclick, %Fastestclick%
Gui, Add, Text, x20 y360 vSlowestClickText, Slowest Click (ms):
Gui, Add, Edit, x150 y360 w120 vSlowestClick, %SlowestClick%
Gui, Add, Text, x20 y400 vHoldKeyText, Hold Key:
Gui, Add, Edit, x150 y400 w120 vHoldKey, %holdKey%
Gui, Add, Button, x150 y50 w120 h30 gApplySettings, Apply Settings
...
gui, +border +caption
Gui, Show, w300 h550, HardPaint's Script
DragHandler(hWnd)
ChangeMode:
...
GuiControl, Font, % "FastestClickText"
GuiControl, Font, % "SlowestClickText"
